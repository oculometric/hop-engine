...
private:
    ...
    std::vector<std::tuple<std::string, std::string, std::string>> images = {
        { "res://nasa/a.jpg",                                     "Webb Studies Star Clusters",
         "ESA/Webb, NASA & CSA, A. Pedrini,\nA. Adamo (Stockholm University) and the FEAST JWST team"                                                                           },
        { "res://nasa/b.jpg",                                   "Hubble Spots a Starry Spiral",
         "ESA/Hubble & NASA, D. Thilker and the PHANGS-HST Team"                                                                                                                },
        { "res://nasa/c.jpg",                                                     "Starstruck",                                                                           "NASA" },
        { "res://nasa/d.jpg",                     "Webb Spots Details in Nearby Spiral Galaxy",
         "ESA/Webb, NASA & CSA, A. Leroy"                                                                                                                                       },
        { "res://nasa/e.jpg",                                "Hubble Spots Lens-Shaped Galaxy",
        ...
        { "res://nasa/g.jpg",                                             "A Galactic Embrace",
         "X-ray: NASA/CXC/SAO; Infrared: NASA/ESA/CSA/STScI/Webb;\nImage Processing: NASA/CXC/SAO/L. Frattare"                                                                  },
        { "res://nasa/h.jpg",                  "Hubble Glimpses Galactic Gas Making a Getaway",
         "ESA/Hubble & NASA, S. Veilleux, J. Wang, J. Greene"                                                                                                                   },
        { "res://nasa/i.jpg",                                            "A Dance of Galaxies",
         "ESA/Webb, NASA & CSA, A. Adamo (Stockholm University),\nG. Bortolini, and the FEAST JWST team"                                                                        },
        { "res://nasa/j.jpg",                  "Massive Stars Make Their Mark in Hubble Image",
         "ESA/Hubble & NASA, F. Annibali, S. Hong"                                                                                                                              },
        { "res://nasa/k.jpg",                       "XRISM Finds Chlorine, Potassium in Cas A",
         "X-ray: NASA/CXC/SAO; Optical: NASA/ESA/STScI; IR: NASA/ESA/CSA/STScI/Milisavljevic et al.,\nNASA/JPL/CalTech; Image Processing: NASA/CXC/SAO/J. Schmidt and K. Arcand" },
        { "res://nasa/l.jpg", "NASA X-Ray Mission Gets Fresh Look at 2,000-Year-Old Supernova",
         "X-ray: Chandra: NASA/CXC/SAO, XMM: ESA/XMM-NEWTON, IXPE:NASA/MSFC;\nOptical: NSF/NOIRLab; Image Processing: NASA/CXC/SAO/J. Schmidt"                                  },
    };
...
public:
    void awake() override
    {
        ...
        Window::setTitle("HopEngine Space Demo");
        Window::setBorderless(true);

        auto scene   = Scene::create("scene");
        sky_material = new Material(Engine::loadShader("res://stars.glsl"),
        ...
        for (const auto& i : images) { Engine::loadTexture(std::get<0>(i)); }
        ...
        title_label->setFormatting(
            UIRenderer::TextFormatting{ UIRenderer::TEXT_ALIGN_RIGHT, UIRenderer::TEXT_FLAGS_UNDERLINE });
        ...
        credit_label->setFormatting(
            UIRenderer::TextFormatting{ UIRenderer::TEXT_ALIGN_RIGHT, UIRenderer::TEXT_FLAGS_ITALIC });
        ...
        overlay->getTransform().setLocalPosition(
            { 0.0f, 3.0f, camera->getTransform().getLocalPosition().z });

        reset();

        Engine::setScene(scene);
        Window::setSize({ 1024, 768 });
        Window::setAspectRatioLock(4, 3);
    }
...
int main()
{
    HopEngine::init(Engine::InitParams{ true, true, Debug::DEBUG_INFO, false });
